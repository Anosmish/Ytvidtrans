...
if __name__ == "__main__":
    ...
    app.run(host="0.0.0.0", port=5000, threaded=True, debug=True)            download_name="speech.mp3",
            mimetype="audio/mpeg"
        )
...
if __name__ == "__main__":
    ...
    app.run(host="0.0.0.0", port=5000, debug=False, threaded=True)            download_name="speech.mp3",
            mimetype="audio/mpeg"
        )
